defmodule RemoteInterviewWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RemoteInterviewWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RemoteInterviewWeb.Gettext, "errors", msg, opts)
    end
  end
